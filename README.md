...
``` sh
$ git clone https://github.com/Mohamed-sobhi95/odoo15.git
...
* Default database password (**admin_passwd**) is `msobhy`, please change it @ [etc/odoo.conf#L60](/etc/odoo.conf#L60)
